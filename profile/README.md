...
| **개요** | AI가 HR 요청과 문서를 분석하고 필요한 절차, 업무카드, 문서 초안을 준비해 담당자의 반복 업무와 누락을 줄이는 서비스 |
...
- 근로자별 계약·체류·서류 상태와 만료일 통합 관리
- 자연어 요청과 업로드 문서를 활용한 HR 업무 생성
- HWP·HWPX 행정서류 초안 작성과 검토 지원
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><sub>Agent Engineering</sub></td>
      <td align="center"><sub>Document Agent Engineering</sub></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="center"><sub>Backend Engineering</sub></td>
    </tr>
  </tbody>
</table>
